...
define('check', ['check-message', 'check-common', 'check-phone', 'check-ident', 'check-safe'], function(message, checkCommon, checkPhone, checkIdent, checkSafe) {

	var check = {};
	var result = message.result;
	var trim = checkCommon.trim;
	var empty = check.empty = checkCommon.empty;
	...
	}, checkPhone, checkIdent, checkSafe);
